  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <Helmet>
          <title>Downsizing in Carver County, MN | Greg Anderson REALTOR®</title>
          <meta name="description" content="Thinking about downsizing in Chaska, Chanhassen, or Waconia? Greg Anderson has helped hundreds of Carver County homeowners navigate this transition since 1985." />
        </Helmet>
