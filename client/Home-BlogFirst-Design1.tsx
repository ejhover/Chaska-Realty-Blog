  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Compact Hero with Blog Posts Immediately Below */}
        <section className="relative bg-gradient-to-br from-primary/5 via-background to-secondary/10 pt-16 pb-8">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
              {/* Left - Intro */}
              <div className="lg:col-span-2">
                <div className="inline-block mb-4 px-4 py-2 bg-primary/10 rounded-full">
                  <p className="text-primary font-semibold text-sm">Carver County's Trusted Realtor</p>
                </div>
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
                  Greg Anderson
                </h1>
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                  Your neighbor, advocate, and guide with 41 years of experience helping 3,000+ families in Carver County.
                </p>
                <button
                  type="button"
                  onClick={() => setConnectOpen(true)}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-all cursor-pointer shadow-lg"
        ...
        {/* BLOG POSTS - IMMEDIATELY VISIBLE */}
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-10">
              <div>
                ...
                <p className="text-muted-foreground text-lg">
                  Expert guidance for buyers, sellers, and homeowners in Carver County
                </p>
              </div>
              <Link
                href="/blog"
